...
public class BottomDrawerBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
  ...
  public BottomDrawerBehavior(@NonNull Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
    TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.BottomDrawerBehavior_Layout);
    TypedValue value = a.peekValue(R.styleable.BottomDrawerBehavior_Layout_peekHeight);
    if (value != null && value.data == PEEK_HEIGHT_AUTO) {
      setPeekHeight(value.data);
    } else {
      setPeekHeight(a.getDimensionPixelSize(R.styleable.BottomDrawerBehavior_Layout_peekHeight, PEEK_HEIGHT_AUTO));
    }
    setHideable(a.getBoolean(R.styleable.BottomDrawerBehavior_Layout_hideable, false));
    setFitToContents(a.getBoolean(R.styleable.BottomDrawerBehavior_Layout_fitToContents, true));
    setSkipCollapsed(a.getBoolean(R.styleable.BottomDrawerBehavior_Layout_skipCollapsed, false));
    setSaveFlags(a.getInt(R.styleable.BottomDrawerBehavior_Layout_saveFlags, SAVE_NONE));
    setHalfExpandedRatio(a.getFloat(R.styleable.BottomDrawerBehavior_Layout_halfExpandedRatio, 0.5f));
    setExpandedOffset(a.getInt(R.styleable.BottomDrawerBehavior_Layout_expandedOffset, 0));
    a.recycle();
  ...
  protected static class SavedState extends AbsSavedState {
    ...
    public SavedState(Parcelable superState, @NonNull BottomDrawerBehavior<?> behavior) {
      super(superState);
    ...
    /**
     * This constructor does not respect flags: {@link BottomDrawerBehavior#SAVE_PEEK_HEIGHT}, {@link
     * BottomDrawerBehavior#SAVE_FIT_TO_CONTENTS}, {@link BottomDrawerBehavior#SAVE_HIDEABLE}, {@link
     * BottomDrawerBehavior#SAVE_SKIP_COLLAPSED}. It is as if {@link BottomDrawerBehavior#SAVE_NONE}
     * were set.
     *
     * @deprecated Use {@link SavedState(Parcelable, BottomDrawerBehavior )} instead.
     */
    @Deprecated
  ...
  public static <V extends View> BottomDrawerBehavior<V> from(@NonNull V view) {
