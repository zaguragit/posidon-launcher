...
public class ViewDragHelper {
    ...
    private static final int MAX_SETTLE_DURATION = 480; // ms
    ...
    private static final Interpolator sInterpolator = new Interpolator() {
        ...
        public float getInterpolation(float x) {
            //return (float) ((Math.pow(Math.cos((x / 2 + 1) * Math.PI), 3)) + 1);
     ...
     */
    public void setMinVelocity(float minVel) { mMinVelocity = minVel; }
     ...
     */
    public float getMinVelocity() { return mMinVelocity; }
     ...
     */
    public int getViewDragState() { return mDragState; }
     ...
     * @see #EDGE_BOTTOM
     */
    public void setEdgeTrackingEnabled(int edgeFlags) { mTrackingEdges = edgeFlags; }
     ...
     */
    @Px
    public int getEdgeSize() { return mEdgeSize; }
     ...
     */
    @Nullable
    public View getCapturedView() { return mCapturedView; }

    /**
     * @return The ID of the pointer currently dragging the captured view,
     *         or {@link #INVALID_POINTER}.
     */
    public int getActivePointerId() { return mActivePointerId; }

    /**
     * @return The minimum distance in pixels that the user must travel to initiate a drag
     */
    @Px
    public int getTouchSlop() { return mTouchSlop; }
    ...
    private int computeAxisDuration(int delta, int velocity, int motionRange) {
        ...
        if (velocity > 0) {
            duration = 4 * Math.round(960 * Math.abs(distance / velocity));
        } else {
