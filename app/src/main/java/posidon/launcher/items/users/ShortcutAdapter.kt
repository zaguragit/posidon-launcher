...
class ShortcutAdapter(private val context: Context, private val shortcuts: List<ShortcutInfo>, private val txtColor: Int) : RecyclerView.Adapter<ShortcutViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ShortcutViewHolder, position: Int) {
        ...
        holder.view.findViewById<ImageView>(R.id.iconimg).setImageDrawable(Global.launcherApps.getShortcutIconDrawable(shortcuts[position], context.resources.displayMetrics.densityDpi))
        holder.view.setOnClickListener {
            ItemLongPress.currentPopup?.dismiss()
            Global.launcherApps.startShortcut(shortcuts[position], null, ActivityOptions.makeCustomAnimation(context, R.anim.appopen, R.anim.home_exit).toBundle())
        }
    }
